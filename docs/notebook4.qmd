...
fig = px.scatter(x=np.arange(k), y=R_wei)
fig.update_layout(
    xaxis_title="Canonical components",
    yaxis_title="Canonical covariances",
...
fig = px.scatter(x=np.arange(k), y=R_bin)
fig.update_layout(
    xaxis_title="Canonical components",
    yaxis_title="Canonical covariances",
...
fig.add_scatter(
    ...
    y=U_bin[:, 0],
    mode="markers",
    name="Structural canonical components",
)
...
fig.add_scatter(
    ...
    y=V_bin[:, 0],
    mode="markers",
    name="Functional canonical components",
)

fig.update_layout(
    xaxis_title="Weighted canonical components",
    yaxis_title="Binary canonical components",
