...
for h in range(2):
    match h:
        case 0:
            R = R_wei
            tlab = "Weighted canonical covariance analysis"
        case 1:
            R = R_bin
            tlab = "Binary canonical covariance analysis"

    # Scatter plots of canonical covariances
    fig = px.scatter(x=np.arange(k), y=R)
    fig.update_layout(
