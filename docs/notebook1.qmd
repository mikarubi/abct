...
conn["Degree-corrected"] = abct.residualn(connectivity, "degree")
conn["Co-neighbor"] = abct.kneighbors(connectivity)
...
coact["Degree-corrected"] = abct.residualn(coactivity, "degree")
coact["Co-neighbor"] = abct.kneighbors(coactivity)
```
