...
arguments
    ...
    Args.objective (1, 1) string {mustBeMember(Args.objective, ...
        ["kmodularity", "alignment_unc", "modularity", "modularity_ctr1", ...
        "modularity_ctr2", "kmeans", "spectral"])} = "kmodularity"
...
if Args.method == "coloyvain"
    assert(ismember(Args.objective, ["kmodularity", "kmeans", "spectral"]), ...
        "co-Loyvain is only compatible with ""kmodularity"", " + ...
        """kmeans"", and ""spectral"" objectives.")
end
...
if Args.similarity == "network"
    ...
    assert(Args.objective ~= "modularity_ctr1", ...
        """modularity_ctr1"" objective is only " + ...
