...
The Loyvain method is a fusion of Lloyd and Louvain methods, two classic algorithms for _k_-means clustering and modularity maximization, respectively. This method specifically interpolates between Lloyd and Louvain, and thus represents unified algorithm for _k_-means clustering and modularity maximization.
...
We will compare the performance of Loyvain across a range of cluster numbers. To do this, we will first define the corresponding similarity or objective functions for each of these methods.
...
We will now use Loyvain method for direct _k_-means clustering and spectral clustering of correlation networks.
...
Finally, we directly compare the clustering similarities of Loyvain method to standard _k_-means and spectral clustering algorithms.
