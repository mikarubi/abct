...
Here, we show that in networks with relatively homogeneous connections within modules, the squared coefficient of variation is equivalent to a variant of the participation coefficient, a popular module-based measure of con-nectional diversity. It is specifically equivalent to the _k_-participation coefficient, the participation coefficient normalized by module size. We show these equivalences in structural and correlation co-neighbor networks from our example brain-imaging data, because these networks have high connectional homogeneity by construction. 
...
fig_imshow(Wn[np.ix_(ordw, ordw)], "Structural co-neighbor network", "inferno").show()
...
### Show maps of squared coefficient of variation
