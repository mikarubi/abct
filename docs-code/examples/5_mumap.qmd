...
Cn = abct.kneighbor(C, "nearest", 50).toarray()   # Correlation nearest-neighbor network

fig_imshow(Cn[np.ix_(ordc, ordc)], "Correlation nearest-neighbor network", "viridis").show()
